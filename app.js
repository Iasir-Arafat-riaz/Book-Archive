      ...
      bookCard.innerHTML = `
                        <div class="card">
                          ...
                          <div class="card-body">
                             ...
                             <p>Writer: <span>${book.author_name!==undefined? book.author_name[0]:"writer not found"}</span> <p>
                             <p>Publisher: <span>${book.publisher!==undefined?book.publisher[0]:"publisher not found"} </span></p>
